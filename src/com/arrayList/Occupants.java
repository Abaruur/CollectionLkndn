...
public class Occupants {
    ...
    private List<Units>preferredRooms = new ArrayList<>();

    public Occupants(String firstName, String lastName, boolean loyaltyProgramMember) {
        super();
    ...
    public List<Units> getPreferredRooms() {
        return preferredRooms;
    }

    public void setPreferredRooms(List<Units> preferredRooms) {
